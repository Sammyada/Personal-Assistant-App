...
# added todos         
    ...
    def remove_todo(self, new_item):
      ...
      if new_item in self.todos:
        ...
        index = self.todos.index(new_item)
        # pop the index for todo_item in todos list
        self.todos.pop(index)
        return f'{new_item} was removed'
      else:
...
# Added birthdays
    ...
    def remove_birthday(self, name):
      if name in self.birthdays:
          ...
          return "This birthday is not on file, sorry."
...
# Complete the get_contact function code
    ...
    def remove_contact(self, name):
      if name in self.contacts:
        ...
        return f"{name} is not in your contacts, could not be removed."
